...
$(document).on('click', '#updateAddress', function(e){
	...
	//deleteGalleryIdClassModal
	$(document).on('click', '#deleteGalleryId', function(){
		var gallery_id = $(this).attr('galleries_id');
		$('#galleries_id').val(gallery_id);
		$("#deleteGallerModal").modal('show');
	});
