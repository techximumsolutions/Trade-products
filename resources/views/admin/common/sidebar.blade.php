...
<span>{{ trans('labels.link_news') }}</span> <i class="fa fa-angle-left pull-right"></i>
        ...
        <li class="treeview {{ Request::is('admin/customers') ? 'active' : '' }}  {{ Request::is('admin/addcustomers') ? 'active' : '' }}  {{ Request::is('admin/editcustomers/*') ? 'active' : '' }} {{ Request::is('admin/addusertierlabel') ? 'active' : '' }}">
          ...
          <a href="{{ URL::to('admin/customers')}}">
            ...
            <li class="{{ Request::is('admin/tierlistings') ? 'active' : '' }} "><a href="{{ URL::to('admin/tierlistings')}}"><i class="fa fa-gears"></i> {{ trans('labels.MenuTierlabes') }}</a></li>
            </ul>
        </li>
         @endif
...
<span> {{ trans('labels.link_site_settings') }}</span> <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Request::is('admin/constantgallery') ? 'active' : '' }} {{ Request::is('admin/addgallery') ? 'active' : '' }} {{ Request::is('admin/editgallery/*') ? 'active' : '' }} {{ Request::is('admin/addconstantgallery') ? 'active' : '' }}"><a href="{{ URL::to('admin/constantgallery')}} "><i class="fa fa-circle-o"></i> {{ trans('labels.link_Constant_Gallery') }}</a></li>
...
<span> {{ trans('labels.Manage Admins') }}</span> <i class="fa fa-angle-left pull-right"></i>
         ...
         @endif
         <li class="treeview {{ Request::is('admin/upload/csv') ? 'active' : '' }} {{ Request::is('admin/setting') ? 'active' : '' }} {{ Request::is('admin/googlesettings') ? 'active' : '' }} {{ Request::is('admin/pushnotification') ? 'active' : '' }} {{ Request::is('admin/orderstatus') ? 'active' : '' }} {{ Request::is('admin/addorderstatus') ? 'active' : '' }} {{ Request::is('admin/editorderstatus/*') ? 'active' : '' }} {{ Request::is('admin/alertsetting') ? 'active' : '' }} {{ Request::is('admin/units') ? 'active' : '' }} {{ Request::is('admin/addunit') ? 'active' : '' }} {{ Request::is('admin/editunit/*') ? 'active' : '' }} ">
          <a href="{{ url('admin/upload/csv')}}">
            <i class="fa fa-gears" aria-hidden="true"></i>
<span>Upload Product File</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
         </li>   
      </ul>
    </section>
