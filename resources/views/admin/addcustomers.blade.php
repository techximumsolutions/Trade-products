                            ...
                            {!! Form::open(array('url' =>'admin/addnewcustomers', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                              ...
                              <!-- user type label -->
                                <div class="form-group">
                                  ...
                                  <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                  {{ trans('labels.TierText') }}</span>
                                  </div>
                                </div>
                                <!-- Discount Products list -->
                                <div class="form-group">
                                  <label for="name" class="col-sm-2 col-md-3 control-label">Discounted Product </label>
                                  <div class="col-sm-10 col-md-4">
                                    <select class="form-control select2" multiple="multiple" name="discounted_product[]" id="discounted_product">
                                     @foreach($customers['discounts'] as $product_info)
                                     <option value="{{$product_info->product_id}}">{{$product_info->products_name}}</option>
                                     @endforeach
                                    </select>
                                  <!-- <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                  {{ trans('labels.StatusText') }}</span> -->
