                  ...
                  <div class="row">
                     <div class="col-12 col-sm-6 pdbt20">
                        <div class="input-group flot">
                           ...
                           <input type="text" name="pass" id="pass" required="" value="">
                        </div>
                     </div>
                     <div class="col-12 col-sm-6 pdbt20">
                        <div class="input-group flot">
                           <label for="confirmpass" class="">Confirm Password *</label>
                           <input type="text" name="confirmpass" id="confirmpass" required="" value="">
                        </div>
                     </div>
                  </div>
                  <div class="pdbt20">
                     <div class="input-group flot">
                        <label for="comp" class="">Company Name *</label>
                        <input type="text" name="comp" id="comp" required="" value="">
                     </div>
                  </div>
                  <div class="pdbt20">
                     <div class="input-group flot">
                        <label for="com" class="animate-label">Do you have and ABN? *</label>
                        <select class="flotin" id="com">
