...
function wrap_text_1(){
    ...
    <script src="https://use.fontawesome.com/adfd7e6af9.js"></script>
    <script src="{!! asset('public/js/bootstrap.min.js?ver=3.4.1') !!}"></script> 
    <script src="//cdn.rawgit.com/tonystar/bootstrap-hover-tabs/v3.1.1/bootstrap-hover-tabs.js"></script>
    <script src="{!! asset('public/js/hc-offcanvas-nav.js?ver=3.4.1') !!}"></script>
