@extends('layout')
@section('content')
<section class="site-content contact_us">
        ...
        <div class="contact-area">
        	...
        	<div class="row">
                <div class="col-12 col-md-6 col-lg-8">
                	{{ strip_tags(@$result['contactus_data']->description)}}
                     ...
                     @endif
                    <form name="signup" class="form-validate gap_from_top" enctype="multipart/form-data" action="{{ URL::to('/processContactUs')}}" method="post">
