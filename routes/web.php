...
Route::group(['prefix' => 'admin'], function () {
	...
	Route::group(['namespace' => 'Admin'], function () {
		...
		*/
			...
			//constant Gallery
			//Route::get('/constantgallery', 'AdminConstantController@constantGallery');
			Route::get('/constantgallery', 'AdminConstantController@constantGallery');
			Route::get('/addconstantgallery', 'AdminConstantController@addconstantGallery');
			Route::post('/addNewConstantgallery', 'AdminConstantController@addNewconstantGallery');
			Route::get('/editconstantgallery/{id}', 'AdminConstantController@editconstantGallery');
			Route::post('/updateconstantgallery', 'AdminConstantController@updateconstantGallery');
			Route::post('/deleteconstantgallery/', 'AdminConstantController@deleteconstantGallery');
			...
			//custom functions
			Route::get('/tierlistings', 'CustomerTierLabel@Alltierlistings');
			Route::post('/deletepricetier/', 'CustomerTierLabel@DeletePriceTier');
			Route::post('/updatepricing', 'CustomerTierLabel@updatepricingtier');
			Route::get('/editpricing/{id}', 'CustomerTierLabel@Edittierlabelpercent');
			Route::get('/upload/csv', 'AdminController@UploadProductCsvFile');
			Route::post('/uploadintodb', 'AdminController@UploadProductCsvFileIntoDB');
...
Route::post('/language/', array(
	...
	Route::get('/gallery', 'GalleryConstantController@PopupGallery');
