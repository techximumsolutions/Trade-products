...
class AdminProductsController extends Controller
{
	...
	public function deleteproduct(Request $request){
		...
		$categories = DB::table('products_discount_price')->where('product_id',$products_id)->delete();
	...
	public function addnewproduct(Request $request){
		...
		// Add product Special Discount
		DB::table('products_discount_price')->insert([
	...
	public function editproduct(Request $request){
		...
		$special_discount = DB::table('products_discount_price')->where('product_id','=', $products_id)->get();
		if(count($special_discount)>0){
			$result['special_discount'] = $special_discount;			
		}else{
            $result['special_discount'][0] = (object) array('id'=>'','product_id'=>'','discount_price'=>'');
		}
	...
	public function updateproduct(Request $request){
		...
		// Add product Special Discount
		DB::table('products_discount_price')->updateOrInsert(['product_id' => $products_id],['discount_price'=>$request->discounted_price]);	
