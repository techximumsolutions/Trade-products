...
class DefaultController extends DataController
{
	...
	public function index(Request $request){
		...
		//
		$banners = DB::table('constant_banners')->join('languages','languages.languages_id','=','constant_banners.languages_id')->orderBy('constant_banners.banners_id','ASC')->paginate(5);
		$result['five_banners_images'] = $banners;
	...
	public function ContactUs(Request $request){
		...
		$result = array();			
		$result['commonContent'] = $this->commonContent();
		$contact_data = DB::table('pages_description')->where('page_id', 10)->first();
		$result['contactus_data'] = $contact_data;
